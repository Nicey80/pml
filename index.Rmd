...
## Summary
Random Forest Classification Model was selected to perform classification fo Exercise. Out of sample error rate was evidenced to be 0.35% - classifying 5835 of 5855 smaples correctly
...
```{r plot}
featurePlot(training[,16:20], training$classe, plot="box", 
            scales = list(y = list(relation="free"),
                          x = list(rot = 90)),  
            layout = c(5,1 ), 
            auto.key = list(columns = 2)
            )
featurePlot(training[,11:15], training$classe, plot="box", 
            scales = list(y = list(relation="free"),
                          x = list(rot = 90)),  
            layout = c(5,1 ), 
            auto.key = list(columns = 2)
